...
<p id="pv"><span style="color:#33b1ef;"> Tose-to-Bar </span> <br>
...
<video width="100%" height="100%"  controls >
  <source src="../../movies/stand2.mp4" type="video/mp4">
</video>
<p id="pv"><span style="color:#33b1ef;"> Standup Jumps </span>  <br>
...
if this movement becoomes two hard during<br> your session then try is altermavtive<br> exercise <span style="color:#33b1ef;"<b><u>Standups</u></b></span> master it 
then try this movement <br> <a href="./2.php">click here for Standups</a>
</p>
</div>	
