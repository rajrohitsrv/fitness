...
<html>
	<head>
		<title>Fitness First/Glutes</title>
	...
	<div class="container" id="con1">
	        <div id="h"><p id="Modal">GLUTES: Exercises, Anatomy<br> And Tips!</p></div>
	...
	<div class="nav2" >
	 ...
	 <li id="so" style=" margin:-1vw 20vw;"><span class="fa fa-user"></span>&nbsp;Hi'&nbsp;<?php echo $userRow['userName']; ?>&nbsp;<i class="fa fa-caret-down" id="myBtn"></i></li>
      <li style="margin:-1vw 0vw; float:left;"><a href="../index.html" style= ""><span class="fa fa-home" ></span></a></li>
			...
			<p id="p1">glutes Anatomy<br><br>all glutes exercise included</p>
		   <img src="../content/images/gultes_1.gif"" height="100%" width="100%">
            ...
            <div class="card__back">
			 <img src="../content/images/gultes_2.jpg" height="100%" width="100%">
            </div>
			</div>
            ...
            <div class="card__back">
			 <img src="../content/images/gultes_3.jpg" height="100%" width="100%">
            </div>
			</div>
			<h1 id="h1">GLUTES EXERCISE<h1>
			  <div class="cardl effect__random" data-id="1">
			  <h1 id="h2">Butt Lift (Bridge)</h1>
			  <p id="p2"> <span style="color:#f8f80c; font-size:2vw;">Tips:</span> Lying on your back with your knees bent, lift your hips off the floor while keeping your back straight. 
		   Remember to keep your glutes tight!<br><br><a href="../video-learning/glutes/1.php">Know More</a>&nbsp;<i class="fa fa-angle-double-right"></i></p>
			   <div class="cardl__front">
            <img src="../content/images/gultes_4.png" height="100%" width="100%">
			</div>
            <div class="cardl__back">
              <img src="../content/images/gultes_5.jpg" height="100%" width="100%">
            </div>
			  </div>
			  
		   <div class="cardl effect__random" data-id="2">
		   <h1 id="h2">Glute Kickback</h1>
		    <p id="p2"> <span style="color:#f8f80c; font-size:2vw;">Tips:</span>  While on the floor on all fours, extend one leg and with the foot cocked to a point that places it in line with the head. Then raise it to a 45-degree angle with the foot elevated above the head. The key to maximum results is to concentrate on contracting 
		   the glutes throughout the full range of motion.<br><br><a href="../video-learning/glutes/2.php">Know More</a>&nbsp;<i class="fa fa-angle-double-right"></i> </p>
			  <div class="cardl__front">
            <img src="../content/images/gultes_6.jpg" height="100%" width="100%">
			</div>
            <div class="cardl__back">
              <img src="../content/images/gultes_7.jpg" height="100%" width="100%">
            </div>
			  </div>
			  
			  <div class="cardl effect__random" data-id="3">
			   <h1 id="h2">Leg Lift</h1>
			   <p id="p2"> <span style="color:#f8f80c; font-size:2vw;">Tips:</span>  Grabbing the top of a chair back to brace yourself, stand up straight, lift one leg behind you while keeping the other leg straight. Bring the raised leg back to the floor and raise it again for 10 repetitions. Then do the same for the other leg. Concentrate on flexing the glutes to that you 
		   feel them do the work. This should begin to tighten and firm these muscles.<br><br><a href="../video-learning/glutes/3.php">Know More</a>&nbsp;<i class="fa fa-angle-double-right"></i> </p>
			  <div class="cardl__front">
            <img src="../content/images/gultes_8.jpg" height="100%" width="100%">
			</div>
            <div class="cardl__back">
              <img src="../content/images/gultes_9.jpg" height="100%" width="100%">
            </div>
			  </div>
