...
<html>
<head>
<title>Overhead Cable Curl</title>
...
<div class="video">
<video width="100%"  poster="../../content/images/bi5.jpg" controls >
  <source src="../../content/video/bi3.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/bi5.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/bi6.jpg" height="100%" width="100%"></div>
<h1>Overhead Cable Curl</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span> To begin, set a weight that is comfortable on each side of the pulley machine. Note: Make sure that the amount of weight selected is the same on each side.<br><br>
<span style="color:#f8f80c;">2.</span> Now adjust the height of the pulleys on each side and make sure that they are positioned at a height higher than that of your shoulders.<br><br>
<span style="color:#f8f80c;">3.</span> Stand in the middle of both sides and use an underhand grip (palms facing towards the ceiling) to grab each handle. Your arms should be fully extended and parallel to the floor with your feet positioned shoulder width apart from each other. Your body should be evenly aligned the handles. This is the starting position.<br><br>
<span style="color:#f8f80c;">4.</span>While exhaling, slowly squeeze the biceps on each side until your forearms and biceps touch.<br><br>
<span style="color:#f8f80c;">5.</span>  While inhaling, move your forearms back to the starting position. Note: Your entire body is stationary during this exercise except for the forearms.<br><br>
 <span style="color:#f8f80c;">6.</span>Repeat for the recommended amount of repetitions prescribed in your program.
 </p>
