...
<html>
<head>
<title>T-Bar Row with Handle</title>
...
<div class="video">
<video width="100%"  poster="../../content/images/mid-back_7.jpg" controls >
  <source src="../../content/video/mid3.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/mid4.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/mid-back_7.jpg" height="100%" width="100%"></div>
<h1>T-Bar Row with Handle</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span>Position a bar into a landmine or in a corner to keep it from moving. Load an appropriate weight onto your end.<br><br>
<span style="color:#f8f80c;">2.</span> Stand over the bar, and position a Double D row handle around the bar next to the collar. Using your hips and legs, rise to a standing position.<br><br>
<span style="color:#f8f80c;">3.</span> Assume a wide stance with your hips back and your chest up. Your arms should be extended. This will be your starting position.<br><br>
<span style="color:#f8f80c;">4.</span> Pull the weight to your upper abdomen by retracting the shoulder blades and flexing the elbows. Do not jerk the weight or cheat during the movement.<br><br>
<span style="color:#f8f80c;">5.</span> After a brief pause, return to the starting position. 
 </p>
