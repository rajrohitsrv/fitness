...
<html>
<head>
<title>Bent Over Barbell Row</title>
...
<div class="video">
<video width="100%"  poster="../../content/images/mid1.jpg" controls >
  <source src="../../content/video/mid1.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/mid1.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/mid-back_3.jpg" height="100%" width="100%"></div>
<h1>Bent Over Barbell Row images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span> Holding a barbell with a pronated grip (palms facing down), bend your knees slightly and bring your torso forward, by bending at the waist, while keeping the back straight until it is almost parallel to the floor. Tip: Make sure that you keep the head up. The barbell should hang directly in front of you as your arms hang perpendicular to the floor and your torso. This is your starting position.<br><br>
<span style="color:#f8f80c;">2.</span> Now, while keeping the torso stationary, breathe out and lift the barbell to you. Keep the elbows close to the body and only use the forearms to hold the weight. At the top contracted position, squeeze the back muscles and hold for a brief pause.<br><br>
<span style="color:#f8f80c;">3.</span> Then inhale and slowly lower the barbell back to the starting position.<br><br>
<span style="color:#f8f80c;">4.</span> Repeat for the recommended amount of repetitions.<br><br>
<span style="color:#f8f80c;">Caution:</span> This exercise is not recommended for people with back problems. A Low Pulley Row is a better choice for people with back issues.
 </p>
