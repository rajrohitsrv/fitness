...
<html>
<head>
<title>Barbell Bench Press - Medium Grip</title>
...
<h1>Barbell Bench Press - Medium Grip</h1>
...
<div class="video">
<video width="100%"  poster="../../content/images/chest-v1.jpg" controls >
  <source src="../../content/video/chest1.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/chest-v1.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/chest-v2.jpg" height="100%" width="100%"></div>
<h1>Barbell Bench Press - Medium Grip images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span> Lie back on a flat bench. Using a medium width grip (a grip that creates a 90-degree angle in the middle of the movement between the forearms and the upper arms), lift the bar from the rack and hold it straight over you with your arms locked. This will be your starting position.<br><br>
<span style="color:#f8f80c;">2.</span> From the starting position, breathe in and begin coming down slowly until the bar touches your middle chest. <br><br>
<span style="color:#f8f80c;">3.</span> After a brief pause, push the bar back to the starting position as you breathe out. Focus on pushing the bar using your chest muscles. Lock your arms and squeeze your chest in the contracted position at the top of the motion, hold for a second and then start coming down slowly again. Tip: Ideally, lowering the weight should take about twice as long as raising it.<br><br>
<span style="color:#f8f80c;">Tips:</span>  Repeat the movement for the prescribed amount of repetitions.
When you are done, place the bar back in the rack.<br><br>
<span style="color:#f8f80c;">Caution:</span> If you are new at this exercise, it is advised that you use a spotter. If no spotter is available, then be conservative with the amount of weight used.
 </p>
