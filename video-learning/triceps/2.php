...
<html>
<head>
<title>Close-Grip Barbell Bench Press</title>
...
<ul>
<li><a href="./1.php">Weighted Bench Dip</a></li>
<li><a href="./2.php">Close-Grip Barbell Bench Press</a></li>
<li><a href="./3.php">EZ-Bar Skullcrusher</a></li>
...
<div class="video">
<video width="100%"  poster="../../content/images/tri3.jpg" controls >
  <source src="../../content/video/tri2.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/tri3.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/tri4.jpg" height="100%" width="100%"></div>
<h1>Close-Grip Barbell Bench Press images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span> Lie back on a flat bench. Using a close grip (around shoulder width), lift the bar from the rack and hold it straight over you with your arms locked. This will be your starting position.<br><br>
<span style="color:#f8f80c;">2.</span> As you breathe in, come down slowly until you feel the bar on your middle chest. Tip: Make sure that - as opposed to a regular bench press - you keep the elbows close to the torso at all times in order to maximize triceps involvement.<br><br>
<span style="color:#f8f80c;">3.</span> After a second pause, bring the bar back to the starting position as you breathe out and push the bar using your triceps muscles. Lock your arms in the contracted position, hold for a second and then start coming down slowly again. Tip: It should take at least twice as long to go down than to come up.<br><br>
<span style="color:#f8f80c;">4.</span> Repeat the movement for the prescribed amount of repetitions.<br><br>
<span style="color:#f8f80c;">5.</span> When you are done, place the bar back in the rack.
 </p>
 <a href="../../exercise/triceps.php">Back to main page <i class="fa fa-arrow-right"></i></a>
 
<div class="rec"> Main Muscle<img src="../../content/images/7.gif" height="100%" width="100%"></div>
</div>
