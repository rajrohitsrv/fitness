...
<html>
<head>
<title>EZ-Bar Skullcrusher</title>
...
Equipment:<span style="color:#33b1ef;">  E-Z Curl Bar</span><br>
...
<div class="video">
<video width="100%"  poster="../../content/images/tri5.jpg" controls >
  <source src="../../content/video/tri3.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/tri5.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/tri7.jpg" height="100%" width="100%"></div>
<h1>EZ-Bar Skullcrusher images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span> Using a close grip, lift the EZ bar and hold it with your elbows in as you lie on the bench. Your arms should be perpendicular to the floor. This will be your starting position. <br><br>
<span style="color:#f8f80c;">2.</span> Keeping the upper arms stationary, lower the bar by allowing the elbows to flex. Inhale as you perform this portion of the movement. Pause once the bar is directly above the forehead. <br><br>
<span style="color:#f8f80c;">3.</span> ift the bar back to the starting position by extending the elbow and exhaling.<br><br>
<span style="color:#f8f80c;">4.</span>Repeat.<br><br>
 </p>
