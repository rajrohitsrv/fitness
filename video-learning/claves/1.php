...
Equipment:<span style="color:#33b1ef;"> Machine</span><br>
...
<div class="video">
<video width="100%"  poster="../../content/images/cal1.jpg" controls >
  <source src="../../content/video/cal1.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/cal_4.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/cal1.jpg" height="100%" width="100%"></div>
<h1>Seated Calf Raise images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span>  Sit on the machine and place your toes on the lower portion of the platform provided with the heels extending off. Choose the toe positioning of your choice (forward, in, or out) as per the beginning of this chapter.<br><br>
<span style="color:#f8f80c;">2.</span> Place your lower thighs under the lever pad, which will need to be adjusted according to the height of your thighs. Now place your hands on top of the lever pad in order to prevent it from slipping forward.<br><br>
<span style="color:#f8f80c;">3.</span> Lift the lever slightly by pushing your heels up and release the safety bar. This will be your starting position.
Slowly lower your heels by bending at the ankles until the calves are fully stretched. Inhale as you perform this movement.<br><br>
<span style="color:#f8f80c;">4.</span> Raise the heels by extending the ankles as high as possible as you contract the calves and breathe out. Hold the top contraction for a second.<br><br>
<span style="color:#f8f80c;">4.</span>Repeat for the recommended amount of repetitions.
 </p>
