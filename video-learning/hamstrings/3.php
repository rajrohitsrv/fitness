...
Main Muscle Worked: <span style="color:#33b1ef;"> Hamstring/glutes/quads</span><br>
...
<div class="video">
<video width="100%"  poster="../../content/images/ham_5.jpg" controls >
  <source src="../../content/video/ham3.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/ham_5.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/ham_6.jpg" height="100%" width="100%"></div>
<h1>Flutter Kicks images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span> On a flat bench lie facedown with the hips on the edge of the bench, the legs straight with toes high off the floor and with the arms on top of the bench holding on to the front edge.<br><br>
<span style="color:#f8f80c;">2.</span> Squeeze your glutes and hamstrings and straighten the legs until they are level with the hips. This will be your starting position. <br><br>
<span style="color:#f8f80c;">3.</span> Start the movement by lifting the left leg higher than the right leg.
Then lower the left leg as you lift the right leg.<br><br>
<span style="color:#f8f80c;">4.</span> Continue alternating in this manner (as though you are doing a flutter kick in water) until you have done the recommended amount of repetitions for each leg. Make sure that you keep a controlled movement at all times. Tip: You will breathe normally as you perform this movement.
 </p>
