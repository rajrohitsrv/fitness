...
<h1>Stiff Leg Barbell Good Morning</h1>
...
<div class="video">
<video width="100%"  poster="../../content/images/low3.jpg" controls >
  <source src="../../content/video/low2.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/low3.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/low4.jpg" height="100%" width="100%"></div>
<h1>Stiff Leg Barbell Good Morning images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span> This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.<br>
<span style="color:#f8f80c;">2.</span> Hold on to the bar using both arms at each side and lift it off the rack by first pushing with your legs and at the same time straightening your torso.<br>
<span style="color:#f8f80c;">3.</span> Step away from the rack and position your legs using a shoulder width medium stance. Keep your head up at all times as looking down will get you off balance and also maintain a straight back. This will be your starting position.<br>
<span style="color:#f8f80c;">4.</span> Keeping your legs stationary, move your torso forward by bending at the hips while inhaling. Lower your torso until it is parallel with the floor.<br>
<span style="color:#f8f80c;">5.</span>   Begin to raise the bar as you exhale by elevating your torso back to the starting position.
Repeat for the recommended amount of repetitions.<br>
<span style="color:#f8f80c;">Caution:</span> This is not an exercise to be taken lightly. Be cautious with the weight used; in case of doubt, use less weight rather than more. The stiff-legged barbell good morning is a very safe exercise but only if performed properly.
 </p>
