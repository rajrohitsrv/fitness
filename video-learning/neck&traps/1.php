...
<html>
<head>
<title>Isometric Neck Exercise - Front And Back</title>
...
<h1>Isometric Neck Exercise - Front And Back</h1>
...
<div class="video">
<video width="100%"  poster="../../content/images/neck-v.jpg" controls >
  <source src="../../content/video/neck1.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/neck-v.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/neck_4.jpg" height="100%" width="100%"></div>
<h1>Isometric Neck Exercise - Front And Back Images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p>1.  With your head and neck in a neutral position (normal position with head erect facing forward), place both of your hands on
 the front side of your head.<br><br>
 2. Now gently push forward as you contract the neck muscles but resisting any movement of your head. Start with slow tension and increase slowly. Keep breathing normally as you execute this contraction.<br><br>
3. Hold for the recommended number of seconds<br><br>
4. Now release the tension slowly.<br><br>
5. Rest for the recommended amount of time and repeat with your hands placed on the back side of your head.<br><br>
<span style="color:#f8f80c;">Variations:</span> You can also do this exercise by placing your hands on the sides of your head. First do one side and then the next.
 </p>
