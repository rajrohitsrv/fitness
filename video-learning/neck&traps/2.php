...
<html>
<head>
<title>Lying Face Down Plate Neck Resistance</title>
...
<h1>Lying Face Down Plate Neck Resistance</h1>
...
Equipment:<span style="color:#33b1ef;">Weighted thing</span><br>
...
<div class="video">
<video width="100%"  poster="../../content/images/neck_6.jpg" controls >
  <source src="../../content/video/neck2.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/neck-v2.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/neck_6.jpg" height="100%" width="100%"></div>
<h1>Lying Face Down Plate Neck Resistance Images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p>1.  Lie face down with your whole body straight on a flat bench while holding a weight plate behind your head. <span style="color:#f8f80c;">Tip:</span> You will need to position yourself so that your shoulders are slightly above the end of a flat bench in order for 
the upper chest, neck and face to be off the bench. This will be your starting position.<br><br>
 2. While keeping the plate secure on the back of your head slowly lower your head (as in saying yes) as you breathe in.<br><br>
3. Raise your head back up to the starting position in a semi-circular motion as you breathe out. Hold the contraction for a second.<br><br>
4.Repeat for the recommended amount of repetitions.<br><br>
<span style="color:#f8f80c;">Caution:</span> As with all exercises, refrain from using any sort of sudden or jerking motions.<br><br>
<span style="color:#f8f80c;">Variations:</span> You can opt to use no resistance at first.
 </p>
