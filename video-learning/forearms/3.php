...
<html>
<head>
<title>Palms-Up Barbell Wrist Curl Over A Bench</title>
...
<h1>Palms-Up Barbell Wrist Curl Over A Bench</h1>
...
<div class="video">
<video width="100%"  poster="../../content/images/for3.jpg" controls >
  <source src="../../content/video/for3.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/for3.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/for2.jpg" height="100%" width="100%"></div>
<h1>Palms-Up Barbell Wrist Curl Over A Bench images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
...
<span style="color:#f8f80c;">2.</span> Use your arms to grab the barbell with a supinated grip (palms up) and bring them up so that your forearms are resting against the flat bench. Your wrists should be hanging over the edge.<br><br>
