...
<html>
<head>
<title>Palms-Down Dumbbell Wrist Curl Over A Bench</title>
...
<h1>Palms-Down Dumbbell Wrist Curl Over A Bench</h1>
...
<div class="video">
<video width="100%"  poster="../../content/images/forearma_3.jpg" controls >
  <source src="../../content/video/for1.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/forearma_4.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/forearma_3.jpg" height="100%" width="100%"></div>
<h1>Palms-Down Dumbbell Wrist Curl Over A Bench images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span>  Start out by placing two dumbbells on one side of a flat bench.
Kneel down on both of your knees so that your body is facing the flat bench.<br><br>
<span style="color:#f8f80c;">2.</span> Use your arms to grab both of the dumbbells with a pronated grip (palms facing down) and bring them up so that your forearms are resting against the flat bench. Your wrists should be hanging over the edge.<br><br>
