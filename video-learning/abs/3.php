...
<div class="video">
<video width="100%"  poster="../../content/images/abs_8.jpg" controls >
  <source src="../../content/video/abs3.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/abs_8.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/abs_9.jpg" height="100%" width="100%"></div>
<h1>Gorilla Chin/Crunch images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span> Hang from a chin-up bar using an underhand grip (palms facing you) that is slightly wider than shoulder width.<br><br>
<span style="color:#f8f80c;">2.</span> Now bend your knees at a 90 degree angle so that the calves are parallel to the floor while the thighs remain perpendicular to it. This will be your starting position. <br><br>
<span style="color:#f8f80c;">3.</span> As you exhale, pull yourself up while crunching your knees up at the same time until your knees are at chest level. You will stop going up as soon as your nose is at the same level as the bar. Tip: When you get to this point you should also be finishing the crunch at the same time.<br><br>
<span style="color:#f8f80c;">4.</span>  Slowly start to inhale as you return to the starting position.
