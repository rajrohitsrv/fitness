...
Equipment:<span style="color:#33b1ef;"> none</span><br>
...
<div class="video">
<video width="100%"  poster="../../content/images/shoulder_3.jpg" controls >
  <source src="../../content/video/shoulder1.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/shoulder_3.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/shoulder_4.jpg" height="100%" width="100%"></div>
<h1>Arm Circles images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span> Stand up and extend your arms straight out by the sides. The arms should be parallel to the floor and perpendicular (90-degree angle) to your torso. This will be your starting position.<br><br>
<span style="color:#f8f80c;">2.</span> Slowly start to make circles of about 1 foot in diameter with each outstretched arm. Breathe normally as you perform the movement. <br><br>
<span style="color:#f8f80c;">3.</span> Continue the circular motion of the outstretched arms for about ten seconds. Then reverse the movement, going the opposite direction.<br><br>
<span style="color:#f8f80c;">Tips:</span>  Ten second movements equal one set and each circle equals one repetition.<br><br>
<span style="color:#f8f80c;">Variations:</span> As you get stronger you can use some light resistance.
 </p>
