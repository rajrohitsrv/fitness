...
<html>
<head>
<title>Back Flyes - With Bands</title>
...
Equipment:<span style="color:#33b1ef;"> Bands</span><br>
...
<div class="video">
<video width="100%"  poster="../../content/images/shoulder_7.jpg" controls >
  <source src="../../content/video/shoulder3.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/shoulder_7.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/shoulder-v3.jpg" height="100%" width="100%"></div>
<h1>Back Flyes - With Bands images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span> Run a band around a stationary post like that of a squat rack.<br><br>
<span style="color:#f8f80c;">2.</span> Grab the band by the handles and stand back so that the tension in the band rises. <br><br>
<span style="color:#f8f80c;">3.</span> Extend and lift the arms straight in front of you. Tip: Your arms should be straight and parallel to the floor while perpendicular to your torso. Your feet should be firmly planted on the floor spread at shoulder width. This will be your starting position.<br><br>
<span style="color:#f8f80c;">4.</span>  As you exhale, move your arms to the sides and back. Keep your arms extended and parallel to the floor. Continue the movement until the arms are extended to your sides.<br><br>
<span style="color:#f8f80c;">4.</span> After a pause, go back to the original position as you inhale.
Repeat for the recommended amount of repetitions.
<span style="color:#f8f80c;">Variations:</span> You can perform this exercise on a rear delt machine as well or using a pulley machine.
 </p>
