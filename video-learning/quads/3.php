...
<div class="video">
<video width="100%"  poster="../../content/images/quads_7.jpg" controls >
  <source src="../../content/video/qud3.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/quads_7.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/quads_8.jpg" height="100%" width="100%"></div>
<h1>Barbell Lunge images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span> This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack just below shoulder level. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.<br><br>
...
<span style="color:#f8f80c;">3.</span> Step away from the rack and step forward with your right leg and squat down through your hips, while keeping the torso upright and maintaining balance. Inhale as you go down. Note: Do not allow your knee to go forward beyond your toes as you come down, as this will put undue stress on the knee joint.<br><br>
<span style="color:#f8f80c;">4.</span> Using mainly the heel of your foot, push up and go back to the starting position as you exhale.<br><br>
<span style="color:#f8f80c;">5.</span> Repeat the movement for the recommended amount of repetitions and then perform with the left leg..
 </p>
