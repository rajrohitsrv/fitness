...
<html>
<head>
<title>Barbell Full Squat</title>
...
<ul>
<li><a href="./1.php">Barbell Full Squat</a></li>
<li><a href="./2.php">Barbell Hack Squat</a></li>
<li><a href="./3.php">Barbell Lunge</a></li>
...
Main Muscle Worked: <span style="color:#33b1ef;"> Quads</span><br>
...
<div class="video">
<video width="100%"  poster="../../content/images/quads_3.jpg" controls >
  <source src="../../content/video/qud1.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/quads_3.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/quads_4.jpg" height="100%" width="100%"></div>
<h1>Barbell Full Squat images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span>This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack just above shoulder level. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.<br><br>
<span style="color:#f8f80c;">2.</span> Hold on to the bar using both arms at each side and lift it off the rack by first pushing with your legs and at the same time straightening your torso. <br><br>
<span style="color:#f8f80c;">3.</span> Step away from the rack and position your legs using a shoulder-width medium stance with the toes slightly pointed out. Keep your head up at all times and maintain a straight back. This will be your starting position.<br><br>
<span style="color:#f8f80c;">4.</span> Begin to slowly lower the bar by bending the knees and sitting back with your hips as you maintain a straight posture with the head up. Continue down until your hamstrings are on your calves. Inhale as you perform this portion of the movement.<br><br>
<span style="color:#f8f80c;">5.</span>  Begin to raise the bar as you exhale by pushing the floor with the heel or middle of your foot as you straighten the legs and extend the hips to go back to the starting position.
Repeat for the recommended amount of repetitions.
 </p>
 <a href="../../exercise/quads.php">Back to main page <i class="fa fa-arrow-right"></i></a>
