...
<ul>
<li><a href="./1.php">Butt Lift (Bridge)</a></li>
<li><a href="./2.php">Glute Kickback</a></li>
<li><a href="./3.php">Leg Lift</a></li>
...
<div class="video">
<video width="100%"  poster="../../content/images/gultes_6.jpg" controls >
  <source src="../../content/video/glu2.mp4" type="video/mp4">
</video>
</div>
</div>

<div class="box2">
<div class="card"><img src="../../content/images/gultes_6.jpg" height="100%" width="100%"></div>
<div class="card"> <img src="../../content/images/gultes_7.jpg" height="100%" width="100%"></div>
<h1>Glute Kickback images</h1>
</div>
<div class="box3">
<h1>Guide</h1>
<p><span style="color:#f8f80c;">1.</span> Kneel on the floor or an exercise mat and bend at the waist with your arms extended in front of you (perpendicular to the torso) in order to get into a kneeling push-up position but with the arms spaced at shoulder width. Your head should be looking forward and the bend of the knees should create a 90-degree angle between the hamstrings and the calves. This will be your starting position.<br><br>
<span style="color:#f8f80c;">2.</span> As you exhale, lift up your right leg until the hamstrings are in line with the back while maintaining the 90-degree angle bend. Contract the glutes throughout this movement and hold the contraction at the top for a second. Tip: At the end of the movement the upper leg should be parallel to the floor while the calf should be perpendicular to it.<br><br>
<span style="color:#f8f80c;">3.</span> Go back to the initial position as you inhale and now repeat with the left leg.<br><br>
<span style="color:#f8f80c;">4.</span> Continue to alternate legs until all of the recommended repetitions have been performed.
 </p>
 <a href="../../exercise/glutes.php">Back to main page <i class="fa fa-arrow-right"></i></a>
 
<div class="rec"> Main Muscle<img src="../../content/images/12.gif" height="100%" width="100%"></div>
</div>
